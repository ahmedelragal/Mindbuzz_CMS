...
<script>
    function downloadExcel() {
        ...
        window.location.href = "{{ route('reports.exportClassContentEngagementReport', $sessionKey) }}";
    }
</script>
@endif
<script>
        ...
        fetch('/assets/fonts/Amiri-Regular.ttf')
            ...
            .then(fontBuffer => {
                ...
                reader.onloadend = function() {
                    ...
                    pdf.setFontSize(18);
                    pdf.text("Class Content Engagement Report", pageWidth / 2, 12, {
                        align: "center"
                    });
                    ...
                    // Save the PDF
                    pdf.save("Class_Content_Engagement_Report.pdf");
                };
