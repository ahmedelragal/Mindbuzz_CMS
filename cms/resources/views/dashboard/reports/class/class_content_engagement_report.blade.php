                                    ...
                                    <form method="GET" action="{{ route('reports.classContentEngagementReport') }}">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select js-select2" name="types[]" id="types" multiple>
                                                    @foreach ($assignmentTypes as $type)
                                                    <option value="{{ $type->id }}" {{ (in_array($type->id, old('types', $request['types'] ?? []))) ? 'selected' : '' }}>
                                                        {{ $type->name }}
                                                    </option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="card mt-4">
                                <div class="card-body">
                                    ...
                                    <ul class="d-flex justify-content-between">
                                        <li>Completed: <b>{{ $counts['completed'] }}</b></li>
                                        <li>Overdue: <b>{{ $counts['overdue'] }}</b></li>
                                        <li>Pending: <b>{{ $counts['pending'] }}</b></li>
                                    </ul>

                                    <h5>Assignments Percentages</h5>
                                    <ul>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $test->due_date }}</td>
                                                <td>{{ $test->status == 1 ? 'Completed' : (new Date($test->due_date) < now() ? 'Overdue' : 'Pending') }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
