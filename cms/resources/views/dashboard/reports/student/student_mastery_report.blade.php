...
<script>
    function downloadExcel() {
        ...
        window.location.href = "{{ route('reports.exportStudentMasteryReport', $sessionKey) }}";
    }
</script>
@endif
        ...
        fetch('/assets/fonts/Amiri-Regular.ttf')
            ...
            .then(fontBuffer => {
                ...
                reader.onloadend = function() {
                    ...
                    pdf.setFontSize(18);
                    pdf.text("Student Mastery Report", pageWidth / 2, 12, {
                        align: "center"
                    });
                    ...
                    // Save the PDF
                    pdf.save("Student_Mastery_Report.pdf");
                };
