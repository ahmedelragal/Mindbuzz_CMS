                        ...
                        <div class="nk-content-body">
                            <div class="card">
                                <div class="card-header" style="display:flex; justify-content: space-between; align-items:center;">
                                    ...
                                    @if (isset($chartLabels) || isset($chartValues) || isset($chartLabels2) || isset($chartValues2) || isset($gamesLabels) || isset($gamesValues))
...
<script>
    function downloadExcel() {
        ...
        window.location.href = "{{ route('reports.exportTeacherHeatmapReport', $sessionKey) }}";
    }
</script>
@endif
<script>
        ...
        fetch('/assets/fonts/Amiri-Regular.ttf')
            ...
            .then(fontBuffer => {
                ...
                reader.onloadend = function() {
                    ...
                    pdf.setFontSize(18);
                    pdf.text("Teacher Heatmap Report", pageWidth / 2, 12, {
                        align: "center"
                    });
                    ...
                    // Save the PDF
                    pdf.save("Teacher_Heatmap_Report.pdf");
                };
