                        ...
                        <div class="nk-content-body">
                            ...
                            <div id="pdf-content">
                                <section id="reports-section">
                                    ...
                                    <div class="row mt-4" id="percentage-graph">
                                        <div class="col-md-4">
                                            <div class="card">
...
<script>
    function downloadExcel() {
        ...
        window.location.href = "{{ route('reports.exportSchoolCompletionReport', $sessionKey) }}";
    }
</script>
@endif
<script>
        ...
        fetch('/assets/fonts/Amiri-Regular.ttf')
            ...
            .then(fontBuffer => {
                ...
                reader.onloadend = function() {
                    ...
                    pdf.setFontSize(18);
                    pdf.text("School Completion Report", pageWidth / 2, 12, {
                        align: "center"
                    });
                    ...
                    domtoimage.toPng(chartCanvas, {
                        ...
                        .then(function(chartImage) {
                            ...
                            // Save the PDF
                            pdf.save("School_Completion_Report.pdf");
                        })
