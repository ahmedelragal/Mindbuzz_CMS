                        ...
                        <div class="nk-content-body">
                            <div class="card">
                                <div class="card-header" style="display:flex; justify-content: space-between; align-items:center;">
                                    <h5 class="title">School Content Engagement Report</h5>
                                ...
                                <!-- Form Section -->
                                <div class="card-body">
                                    <form method="GET" action="{{ route('reports.schoolContentEngagementReport') }}">
                                        <div class="row">
                                            <!-- School Filter -->
                                            @role('Admin')
                                            <div class="col-md-4">
...
<script>
    function downloadExcel() {
        ...
        window.location.href = "{{ route('reports.exportSchoolContentEngagementReport', $sessionKey) }}";
    }
</script>
@endif
<script>
        ...
        fetch('/assets/fonts/Amiri-Regular.ttf')
            ...
            .then(fontBuffer => {
                ...
                reader.onloadend = function() {
                    ...
                    pdf.setFontSize(18);
                    pdf.text("School Content Engagement Report", pageWidth / 2, 12, {
                        align: "center"
                    });
                    ...
                    // Save the PDF
                    pdf.save("School_Content_Engagement_Report.pdf");
                };
...
<script>
    $(document).ready(function() {
        ...
        $('#school_id').change(function() {
            var schoolElement = document.getElementById("school_id");
            var schoolId = null; // Default value

            if (schoolElement) {
                if (schoolElement.tagName === "SELECT") {
                    // If it's a dropdown, get the selected option's data attribute
                    schoolId = $('#school_id option:selected').data('school') || $('#school_id').val();
                } else if (schoolElement.tagName === "INPUT") {
                    // If it's a hidden input, get its value directly
                    schoolId = schoolElement.value;
                }
            }
