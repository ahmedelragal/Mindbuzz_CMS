...
<script>
    function downloadExcel() {
        ...
        window.location.href = "{{ route('reports.exportSchoolContentGapReport', $sessionKey) }}";
    }
</script>
@endif
<script>
        ...
        fetch('/assets/fonts/Amiri-Regular.ttf')
            ...
            .then(fontBuffer => {
                ...
                reader.onloadend = function() {
                    ...
                    pdf.setFontSize(18);
                    pdf.text("School Content Gap Report", pageWidth / 2, 12, {
                        align: "center"
                    });
                    ...
                    // Save the PDF
                    pdf.save("School_Content_Gap_Report.pdf");
                };
